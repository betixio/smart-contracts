 ...
 *Passed an audit: https://docs.betix.io/product-docs/usdbetx-token/smart-contracts
*/
...
contract Betix is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public constant teamWallet = 0xfD9260231D36d779b4Bc6c257D3B3caca23363E7;
    ...
    function _transfer(
        ...
        require(sender != address(0), "Betix: Transfer from the zero address");
        require(recipient != address(0), "Betix: Transfer to the zero address");
        ...
        if (
            ...
            if (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) {
                ...
                require(amount <= _maxTxAmount, "Betix: Transaction limit Exceeded!");
        ...
        require(
            ...
            "Betix: Transfer amount exceeds balance"
        );
    ...
    function updateFees(
        ...
        require(
            ...
            "Betix: You cannott set fee more than 25%"
        );
    ...
    onlyOwner
    {
        require(Account != address(0), "Betix: You can't exclude zero address!");
    ...
    function setMaxTxPercentage(uint256 maxTxPercentage) external onlyOwner {
        require(
            maxTxPercentage >= 1,
            "Betix: Percentage should be greater or equal to 1!"
        );
    ...
    function _mint(address account, uint256 amount) public virtual onlyOwner {
        ...
        require(
            ...
            "Betix: You can't mint more than MaxSupply"
        );
        require(account != address(0), "Betix: mint to the zero address");
    ...
    function _burn(uint256 amount) external virtual {
        ...
        require(account != address(0), "Betix: burn from the zero address");

        _beforeTokenTransfer(account, address(0), Amount);

        uint256 accountBalance = _balances[account];
        require(accountBalance >= Amount, "Betix: burn amount exceeds balance");
    ...
    function _approve(
        ...
        require(owner != address(0), "Betix: approve from the zero address");
        require(spender != address(0), "Betix: approve to the zero address");
